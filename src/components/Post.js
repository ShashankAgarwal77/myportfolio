    ...
    return (
        <main className="bg-black-100 min-h-screen p-12">
            <section className="container mx-auto">
                <h1 className="text-5xl flex justify-center cursive text-white"> Case Studies</h1>
                <h2 className="text-lg text-gray-600 flex justify-center mb-12">Selected case-studies are here to present my work</h2>
